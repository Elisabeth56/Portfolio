export const site = {
  ...
  intro:
    "Computer science student and AI software engineer. I build multi-agent orchestration, retrieval grounded in schemas that actually exist, and inference that keeps working with the network unplugged.",

  /** Longer identity copy — document mode section 01, and the About window. */
  about: [
    "I am a computer science student and an AI software engineer. Most of what I build sits in the same place: the layer between a language model and a system that has to be correct.",
